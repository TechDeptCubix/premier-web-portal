  ...
  return (
    <div>
      <div className="ListOfOrder-main-container">
        ...
        <hr className="ListOfOrder-divider" />

        <div className="ListOfOrder-inner-container">
          <h4>Search Options</h4>

          <div className="ListOfOrder-radio-container">
            <input
              type="radio"
          ...
          <div className="ListOfOrder-radio-container">
            ...
            <span className="ListOfOrder-dateInput-label">From</span>
            <input
              name="date-range-from-input"
              type="text"
              className="ListOfOrder-dateInput"
            />
            <img src={ic_calendar} className="ListOfOrder-dateInput-img" />
            <span className="ListOfOrder-dateInput-label">To</span>
            <input
          ...
          <div className="ListOfOrder-select-container">
            <label>Status</label>
          ...
          <div className="ListOfOrder-my-order-container">
            <input
              type="checkbox"
              name="my-orders-only"
          ...
          <button className="ListOfOrder-search-button">Search Orders</button>
        </div>

        <BackgroundImage />
      </div>

      <div className="ListOfOrder-table-container">
        <table className="ListOfOrder-table">
          <thead>
            <tr>
              <th>Ref.No.</th>
              <th>Order No.</th>
