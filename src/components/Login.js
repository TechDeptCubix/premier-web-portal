...
function Login(){
    return(
        <div className="Login-page-height">
            <div className="Login-logo-container"><img src={logo} className="Login-header-logo"/></div>
            ...
            <div className="Login-main-section">
                ...
                <div className="Login-main-section-content">
                    ...
                    <div className="Login-pqp-items-carousel">
                        <ul>
                            <li><img src={part_1} /></li>
                            <li><img src={part_2} /></li>
                            <li><img src={part_3} /></li>
                            <li><img src={part_4} /></li>
                            <li><img src={part_5} /></li>
                            <li><img src={part_6} /></li>
                            <li><img src={part_7} /></li>
                        </ul>
                    </div>
                    ...
                    <div className="Login-bottom-bar">
                        <div className="Login-brand-list-container">
                            <ul>
                                ...
                                <li><img src={toyota_logo} /></li>
                                <li><img src={fuso_logo} /></li>
                                <li><img src={hyundai_logo} /></li>
                                <li><img src={Infiniti_logo} /></li>
                                <li><img src={isuzu_logo} /></li>
                                <li><img src={lexus_logo} /></li>
                                <li><img src={mazda_logo} /></li>
                                <li><img src={nissan_logo} /></li>
                                <li><img src={peugeot_logo} /></li>
                                <li><img src={renault_logo} /></li>
                            </ul>
                        </div>
                        <div className="Login-bottom-strip-content"> <span>powered by </span><img src={cubix_logo} /></div> 
                    </div>
                </div> 
